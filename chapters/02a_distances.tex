...
\begin{table}[H]
	...
	\caption{Euclidean distances between consecutive points of
		the sequence $n \equiv 1,5 \pmod{6}$ (P\,=\,prime, C\,=\,composite)}
	\begin{tabular}{ccccccc}
		\toprule
		$(n_1, n_2)$ & $\Delta n$ & $k(n_1)$ & $k(n_2)$ & Distance $d$ & Exact value \\
		\midrule
		$( 1,  5)$ & 4 &   1 &  11 &  10.770 & $\sqrt{116}$  \\
		$( 5,  7)$ & 2 &  11 &  20 &   9.220 & $\sqrt{85}$   \\
		$( 7, 11)$ & 4 &  20 &  46 &  26.306 & $\sqrt{692}$  \\
		$(11, 13)$ & 2 &  46 &  63 &  17.117 & $\sqrt{293}$  \\
		$(13, 17)$ & 4 &  63 & 105 &  42.190 & $\sqrt{1780}$ \\
		$(17, 19)$ & 2 & 105 & 130 &  25.080 & $\sqrt{629}$  \\
		$(19, 23)$ & 4 & 130 & 188 &  58.138 & $\sqrt{3380}$ \\
		$(23, 25)$ & 2 & 188 & 221 &  33.061 & $\sqrt{1093}$ \\  % 25 = 5² composite
		$(25, 29)$ & 4 & 221 & 295 &  74.108 & $\sqrt{5492}$ \\
		$(29, 31)$ & 2 & 295 & 336 &  41.049 & $\sqrt{1685}$ \\
		\bottomrule
	\end{tabular}
\end{table}
\end{example}
...
\begin{tabular}{cccc}
\toprule
Interval & Distance $d$ & Arc length $L$ & Ratio $d/L$ \\
\midrule
$[1, 5]$   & 10.770 & 10.839 & 0.9936 \\
$[5, 7]$   & 9.220  & 9.221  & 0.9999 \\
$[7, 11]$  & 26.306 & 26.310 & 0.9998 \\
$[11, 13]$ & 17.117 & 17.117 & 1.0000 \\
$[13, 17]$ & 42.190 & 42.191 & 1.0000 \\
\bottomrule
\end{tabular}
\end{table}
...
\[
\{d_k\} = \{10.770,\ 9.220,\ 26.306,\ 17.117,\ 42.190,\ 25.080,\ \ldots\}
\]
\end{example}
