...
rapidly to the exact 3D curvature (deviation below 2\,\%):
\end{remark}
...
$\tau(\theta) \sim c_1/a^2 = \pi^3/12$, i.e.\ the torsion converges to
a non-zero constant --- in contrast to the planar spiral, whose torsion
