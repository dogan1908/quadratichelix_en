...
\end{equation}
which possesses a remarkable Diophantine property: it takes integer
...
The work is organised into five parts. \textbf{Part~I}
...
\textbf{Part~IV} (Chapters~\ref{ch:cone}--\ref{ch:primes}) constructs the
