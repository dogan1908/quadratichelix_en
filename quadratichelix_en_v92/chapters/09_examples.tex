...
\theta_1 = \frac{\pi}{3}\cdot 1 + \frac{\pi}{4} = 1.83259571,\quad
\theta_2 = \frac{\pi}{3}\cdot 5 + \frac{\pi}{4} = 6.02138592.
\]
...
= \frac{0.31579010}{10.83940915} = \boxed{+2.913\,\%}.
\]
...
\midrule
1 & $1 \to 5$   & Major
  & 10.83940915 & 11.15519925 & $+0.31579010$ & $+2.913\,\%$ \\
2 & $5 \to 7$   & Minor
  & 9.22107493  & 9.30913741  & $+0.08806248$ & $+0.955\,\%$ \\
3 & $11 \to 13$ & Minor
  & 17.11747993 & 17.16486194 & $+0.04738201$ & $+0.277\,\%$ \\
4 & $17 \to 19$ & Minor
  & 25.07994766 & 25.11227648 & $+0.03232881$ & $+0.129\,\%$ \\
5 & $23 \to 25$ & Minor
  & 33.06058334 & 33.08510518 & $+0.02452184$ & $+0.074\,\%$ \\
6 & $35 \to 37$ & Minor
  & 49.04080939 & 49.05733914 & $+0.01652975$ & $+0.034\,\%$ \\
\bottomrule
\end{tabular}
\end{table}
...
$Q(k) = \sqrt{48k+1} = 4n+3$ (introduced formally in
Section~\ref{subsec:Q}). With $dQ = 4\,dn$ and
...
For all interval pairs from $n = 11$ onwards --- in particular for all
primes $p \geq 11$ --- the deviation is below $0.3\,\%$. For
applications in the visualisation of prime distributions this accuracy
is fully sufficient.
\end{corollary}
