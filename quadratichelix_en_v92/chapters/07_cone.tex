...
The three-dimensional structure arises from a specific geometric process.
...
\emph{conical helix}, and the cone itself is the envelope of the
...
This value marks the origin of the construction: it is the point of
...
The point $(0,-\tfrac{3}{4})$ must therefore lie on the cone. This identification is the single normalisation of the construction; the slope of the height function carries no such freedom (Proposition~\ref{prop:height-uniqueness} in Chapter~\ref{ch:helix}). Substituting
